...
description: "Windows privilege escalation vectors: Situational awareness, User privileges, Token impersonation, Service exploits, and Registry misconfigurations."
image:
  path: /assets/img/posts/windows_privesc.jpg
  alt: Windows PrivEsc
---
...
![image.png](/assets/img/writeups/windows_privesc_image.png)
